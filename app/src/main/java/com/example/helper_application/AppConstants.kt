...
object AppConstants {
    ...
    /** Cube-style: helper notifies main app after file is saved (local recording path). */
    const val ACTION_RECORD_COMPLETE = "$MES_VALIDATION_PACKAGE.action.RECORD_COMPLETE"

package com.example.helper_application.dialer.core.domain.usecase

import android.content.Context
import android.provider.CallLog
import android.provider.ContactsContract
import com.example.helper_application.dialer.core.domain.model.ContactMatch
import com.example.helper_application.dialer.core.domain.model.MatchSource
import com.example.helper_application.dialer.core.utils.DialerTabPermissions
import com.example.helper_application.dialer.core.utils.T9Mapper
...
class ContactSearchUseCase @Inject constructor(
    ...
    private fun searchContacts(
        ...
        if (!DialerTabPermissions.hasContactsPermission(context)) return
    ...
    private fun searchCallLog(
        ...
        if (!DialerTabPermissions.hasCallLogPermission(context)) return
        val projection = arrayOf(
